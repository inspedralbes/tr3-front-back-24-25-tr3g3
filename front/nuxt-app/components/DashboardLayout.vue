<template>
      ...
      <div class="flex items-center justify-between">
        <div class="flex items-center justify-start rtl:justify-end">
          ...
          <NuxtLink to="/" class="flex ms-2 md:me-24">
            ...
            <span
              class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">Application</span>
          </NuxtLink>
        </div>
        <div class="flex items-center">
          <div class="flex items-center ms-3">
            <div v-if="true" class="relative ml-3">
              <button @click="toggleUserMenu" type="button"
                ...
                <img class="size-8 rounded-full cursor-pointer" :src="profileImage" alt="Profile">
              </button>
  ...
  <div class="p-4 sm:ml-64 flex flex-col h-full">
    <div class="h-full p-4 mt-14 flex-1">
      <slot></slot>
    </div>
  </div>
...
const profileImage = ref('/profile-icon.jpg')

<template>
    <div>
            ...
            <div class="flex items-center">
              <div class="flex items-center ms-3">
                ...
                <div v-if="isUserMenuOpen"
                  class="z-50 absolute right-0 mt-32 text-base list-none bg-white divide-y divide-gray-100 rounded-sm shadow-sm dark:bg-gray-700 dark:divide-gray-600">
                  ...
                  <ul class="py-1" role="none">
                    ...
                    <li>
                      <NuxtLink to="/earnings"
                        class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600 dark:hover:text-white"
                        role="menuitem">Earnings</NuxtLink>
                    </li>
                    <li>
                      <NuxtLink to="/logout"
                        class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600 dark:hover:text-white"
      ...
      <div class="p-4 sm:ml-64">
        <div class="p-4 border-2 border-gray-200 border-dashed dark:border-gray-700 mt-14">
          <!-- Reemplazado el comentario con el slot para inyectar contenido -->
          <slot></slot>
        </div>
      </div>
    </div>
  ...
  // Computado para las clases del sidebar
  const sidebarClass = computed(() => {
    return isSidebarOpen.value ? '' : '-translate-x-full sm:translate-x-0';
  });
  ...
  // Método para alternar el sidebar en móvil
  const toggleSidebar = () => {
  ...
  const closeUserMenuOnOutsideClick = (event) => {
    // Implementación para cerrar menú al hacer clic fuera
    if (isUserMenuOpen.value && !event.target.closest('.user-menu-container')) {
      isUserMenuOpen.value = false;
    }
  };
  
  // Si necesitas escuchar clicks globales (puedes usar onMounted)
  onMounted(() => {
